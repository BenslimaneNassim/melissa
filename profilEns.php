        ...
        <div class="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li><a href="planningEns.php"><i class="bx bxs-calendar-event"></i>
                        Planning</a></li>
                <li class="active"><a href="profilEns.php"><i class='bx bx-cog'></i>Paramétres</a></li>
            </ul>
            <ul class="side-menu">
                <li>
                ...
                <div class="profile-menu" id="profileMenu">
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="modifierProfilEns.php"> Modifer Profile</a>
                        </li>
                        <li>
                    ...
                    <div class="orders">
                        <div class="header">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div class="col-12">
                                    <a href="modifierProfilEns.php?id='.$nom.'"><button class="btn btn-primary w-50">Modifer
                                        </button></a>
                                </div>
